...
export const PauseIcon: React.FC = () => (
    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M10 9.75v4.5m4-4.5v4.5" />
    </svg>
);
...
export const LogoIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    className={className}
    aria-label="A( )VOID Logo"
  >
    <path d="M0 20H40" stroke="currentColor" strokeWidth="4" />
    <path d="M80 20H120" stroke="currentColor" strokeWidth="4" />
    <circle cx="60" cy="20" r="18" stroke="currentColor" strokeWidth="4" />
  </svg>
);
